    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <section className="relative z-10 py-12 px-6">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold gradient-text mb-2">Mentors</h2>
            {isLoading ? (
              ...
              <p className="text-lg text-gray-300">{Array.isArray(mentors) ? mentors.length : 0} mentors available</p>
            )}
          </div>
              ...
              <Card key={mentor._id || mentor.id} className="glass-card-hover group relative overflow-hidden">
                ...
                <CardHeader className="relative z-10">
                  <div className="flex items-start space-x-4 mb-6">
                    <div className="relative">
                      <div className="w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-2xl font-bold text-white neon-glow">{(mentor.name || 'M').slice(0,2).toUpperCase()}</div>
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-lg text-gray-300">{mentor.title}</p>
                      <p className="text-lg text-blue-400 font-semibold">{mentor.company}</p>
                  ...
                  <p className="text-gray-300 mb-4 leading-relaxed">{mentor.bio}</p>

                  <div className="space-y-3 mb-6">
                    <div className="flex items-center space-x-2">
                      <Clock className="w-4 h-4 text-blue-400" />
                      <span className="text-sm text-gray-300">Available: {mentor.availability}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-400" />
                      <span className="text-sm text-gray-300">Response time: {mentor.responseTime}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Languages className="w-4 h-4 text-purple-400" />
                      <span className="text-sm text-gray-300">{Array.isArray(mentor.languages) ? mentor.languages.join(", ") : mentor.languages}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <MapPin className="w-4 h-4 text-orange-400" />
                      <span className="text-sm text-gray-300">{mentor.timezone}</span>
                    </div>
                  ...
                  <div className="mb-6">
                    <h5 className="text-sm font-semibold text-gray-400 mb-3">EXPERTISE</h5>
                ...
                <CardContent className="relative z-10">
                  <Button
                    ...
                    className={`w-full bg-gradient-to-r from-blue-500 to-purple-500 hover:scale-105 transition-transform duration-300 text-lg py-3`}
                  >
      ...
      <Dialog open={showBookingDialog} onOpenChange={setShowBookingDialog}>
        <DialogContent className="bg-gray-900 border-gray-700 max-w-2xl">
          <DialogHeader>
            <DialogTitle className="text-2xl gradient-text">Book a Session</DialogTitle>
